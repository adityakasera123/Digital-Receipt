...
export default function SecuritySection() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Email Verification */}
      <div className="rounded-2xl border border-default bg-surface p-6 transition-theme">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <span
            className={`inline-flex w-fit items-center justify-center rounded-full px-3 py-1.5 text-xs font-semibold leading-none ${
              user?.emailVerified
